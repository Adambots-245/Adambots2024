...
public class ShootWhenAligned extends Command {
  ...
  @Override
  public void execute() {
    if (shooterSubsystem.isAtTargetSpeed() && armSubsystem.getCurrentStateName() == "speaker" && armSubsystem.isAtTargetState() && VisionHelpers.isAligned(VisionConstants.aprilLimelite, 3) && VisionHelpers.getAprilHorizDist() < 3) {
