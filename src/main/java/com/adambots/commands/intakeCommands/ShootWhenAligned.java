...
public class ShootWhenAligned extends Command {
  ...
  @Override
  public void execute() {
    if (shooterSubsystem.isAtTargetSpeed() && (armSubsystem.getCurrentStateName() == StateName.SPEAKER || armSubsystem.getCurrentStateName() == StateName.CLOSE_FLOOR_SHOOT) && armSubsystem.isAtTargetState() && VisionHelpers.isAligned(VisionConstants.aprilLimelite, 3) && VisionHelpers.getAprilHorizDist() < 3) {
