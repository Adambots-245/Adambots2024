...
public class RotateToAprilCommand extends Command {
  ...
  private final PIDController turningPIDController = new PIDController(VisionConstants.kPThetaController, 0, VisionConstants.kDThetaController);
  private int alignedCount;
  private double drive_output;
  private double offset;

  public RotateToAprilCommand(DrivetrainSubsystem driveTrainSubsystem, CANdleSubsystem caNdleSubsystem, double offset) {
