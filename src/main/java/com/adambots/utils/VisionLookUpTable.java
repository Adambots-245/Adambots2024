...
public class VisionLookUpTable {
    ...
    public VisionLookUpTable() {
        ...
        shooterConfig.getShooterConfigs().add(new ShooterPreset(125, 312, 90, 1));
        shooterConfig.getShooterConfigs().add(new ShooterPreset(125, 314, 90, 1.5));
        shooterConfig.getShooterConfigs().add(new ShooterPreset(125, 315, 90, 2));
        shooterConfig.getShooterConfigs().add(new ShooterPreset(125, 316, 90, 2.5));
        shooterConfig.getShooterConfigs().add(new ShooterPreset(125, 318, 90, 3));
                shooterConfig.getShooterConfigs().add(new ShooterPreset(125, 322, 90, 3.5));
