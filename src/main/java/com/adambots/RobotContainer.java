...
public class RobotContainer {
  ...
  private void registerNamedCommands() {
    ...
    NamedCommands.registerCommand("AprilAlignCommand", new ParallelRaceGroup(new ParallelCommandGroup(new OdomSpeakerAlignCommand(drivetrainSubsystem, armSubsystem, shooterSubsystem, candleSubsytem, VisionConstants.defaultAprilLimelite), new InterpolateDistanceCommand(armSubsystem, shooterSubsystem, drivetrainSubsystem, intakeSubsystem, VisionLookUpTable.lowShooterConfig)), new VisionOdomResetCommand(drivetrainSubsystem, VisionConstants.defaultAprilLimelite)));
    ...
    NamedCommands.registerCommand("VisionOdomReset", new VisionOdomResetCommand(drivetrainSubsystem, VisionConstants.defaultAprilLimelite));
    ...
    NamedCommands.registerCommand("NF2_OdomReset", new InstantCommand(() -> drivetrainSubsystem.resetOdometryXY_TEMP(new Pose2d(8.28, 5.77, new Rotation2d()))));
