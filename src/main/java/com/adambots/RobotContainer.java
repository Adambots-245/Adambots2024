...
public class RobotContainer {
 ...
 private final HangSubsystem hangSubsystem = new HangSubsystem(RobotMap.leftHangMotor, RobotMap.rightHangMotor, RobotMap.leftHangLimit, RobotMap.rightHangLimit);
